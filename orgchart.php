...
<!-- ------------------------------------------------BODY------------------------------------------- -->
        ...
        <!--Start of welcome banner (white area)-->
                <section id="credit">               
                        <div class="cre_header">
                            <h2 style="font-size: 0.5in;">Unahco Central Credit Organizational Chart!</h2>
                            </div>
                </section>
        ...
        <!--Start of ORG CHart -->
    <section id="orgchart">    
            <h1 >Unahco Central Credit Organizational Chart</h1>
            ...
            ?>
            <span>
              <?php  echo "<img src=data:image/jpeg;base64," . (base64_encode(($row['img_orgchart']))) ; ?>
            </span>
