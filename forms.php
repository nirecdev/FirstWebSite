        ...
        <!--End of Hedaer Section-->
                ...
                <section id="credit">               
                        <div class="cre_header">
                            <h2 style="font-size: 0.7in;"> Unahco Central Credit Forms!</h2>
                        </div>
      ...
      <section id = "forms">
        ...
        <div class="output">
            ...
            <table style="width: 1400px;margin: auto;">
                   <!-- <th>Database ID</th> -->                    <!-- Hidden from public, only for editing -->           
                    <th>Form Name</th>
                    <th>Form Link</th>
                    ...
                    <tr style="text-transform: uppercase; font-weight: 500;">
                     <!--   <td><?php// echo $row['id_forms'] ?></td> --> <!-- Hidden from public, only for editing -->
        ...
        <!-- End of Forms output transffered to Admin.php -->
