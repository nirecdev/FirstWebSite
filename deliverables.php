...
<!-------------------------------------------------Body Content---------------------------------------------->
                ...
                <section id="credit">               
                        <div class="cre_header">
                            <h2 style="font-size: 0.7in;"> Unahco Central Credit Deliverables!</h2>
                        </div>
        ...
        <div class="output">
            ...
            <table style="width: 1400px;margin: auto;" >
                <!--    <th>Databse ID</th> --> <!-- Hidden from public, only for editing -->
                    <th>Employee Name</th>
                    ...
                    <!--    <td><?php// echo $row['id'] ?></td> --> <!-- Hidden from public, only for editing -->
        ...
        <!-- OUTPUT ONLY THE EDIT IS IS ADMIN. -->
