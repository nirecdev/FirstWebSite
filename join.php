        ...
        <!--Start of welcome banner (white area)-->
                <section id="credit">               
                        <div class="cre_header">
                            <h2 style="font-size: 0.5in;">Become a Warrior!</h2>
                            <p style="font-size: 16px; text-align: center; ">UNAHCO, Inc. (UNIVET Nutrition and Animal Healthcare Company) is the agribusiness subsidiary of pharmaceutical leader Unilab.</p>
                            </div>
                </section>
                ...
                <div class="row war_area">
                    <div class="col-md-8">
                        <div class="warrior_content">
                            ...
                            <p>Join Our Team And Help the world.</p>
                        ...
                        <div class="join">
                            <div class="form_area">
                                ...
                                <div class="contact-form wow fadeIn animated" data-wow-offset="10" data-wow-duration="1.5s">
                                    <div id="message"></div>
                                    <form action="join.php" class="form-horizontal contact-1" role="form" name="contactform" id="contactform">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="text_area">
                                                    <textarea name="contact-message" id="msg" class="form-control" rows="15" placeholder="Message"></textarea>
                                                </div>
                                               <div class="col-sm-4">
                                                <input type="file" class="form-control" id="attachment_join" placeholder="Attachment *"></div>   
                                                <div class="col-sm-4">
                                            <button type="submit" class="btn bcustom-btn" data-loading-text="Loading...">Join Us</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<!--Start of slider section PARTNERS-->
        <section id="slider_partner">
            <?php   $ImageArray_partner = array();
