...
<!-------------------------------------------------Body Content---------------------------------------------->
        ...
        <!--Start of welcome banner (white area)-->
                <section id="credit">               
                        <div class="cre_header">
                            <h2 style="font-size: 0.7in;"> Unahco Central Credit Roles!</h2>
                        </div>
       ...
       <!------------ROLES------------->
        ...
        <section id="roles">
            ...
            <h1 style="text-align: center; font-weight: 800;">Roles</h1>
...
<div class="bf">
        ...
        <!-- OUTPUT ONLY SO NO NEED FOR ACTION=ROLES OR ADMIN.PHP -->
                    ...
                    <div class="col-md-6">
                        <div class="office">
                            ...
                            <div class="office_location">
                                ...
                                <div class="email">
                                    <i class="fa fa-envelope"><span>ucentralcredit@gmail.com</span></i>
                                </div>
                                <div id="mappic"> <img src="img/googlemap.png"></divad                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="msg">
